          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Ukupan broj korisnika</span>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="progress-group">
                      Aktivni korisnici
                      <span class="float-right"><b>{{$active_users}}</b>/{{$users}}</span>
                      <div class="progress progress-sm">
                        <div class="progress-bar bg-success" style="width: {{ $active_users/$users * 100 }}%"></div>
                      </div>
                    </div>
