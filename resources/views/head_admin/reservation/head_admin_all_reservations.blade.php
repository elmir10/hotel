              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>{{ $reservation->processed_by }}</td>
                    <td>
                        @if($reservation->processed == '1')
                            <a href="#" class="btn btn-success" title="Rezervacija je odobrena" disabled><i class="fa fa-check"></i></a></td>
                        @else
                            <a href="{{ route('head_admin.approve_reservation', $reservation->id) }}" class="btn btn-success" title="Odobri" id="approve"><i class="fa fa-check"></i></a></td>
                        @endif
                  </tr>       
                  @endforeach
                  </tbody>
