    ...
    <li class="nav-item dropdown">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          @endforeach
          <div class="dropdown-divider"></div>
          <a href="{{ route('head_admin.all_reservations_notification') }}" class="dropdown-item dropdown-footer">Pogledaj sve zahtjeve</a>
        </div>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <div class="dropdown-divider"></div>
          <a href="{{ route('head_admin.profile') }}" class="dropdown-item">
            <i class="far fa-address-card mr-2"></i> Profil
          </a>
          <div class="dropdown-divider"></div>
          <a href="{{ route('head_admin.change.password') }}" class="dropdown-item">
            <i class="fas fa-wrench mr-2"></i> Promijeni lozinku
          </a>
          <div class="dropdown-divider"></div>
          <a href="{{ route('head_admin.picture') }}" class="dropdown-item">
            <i class="fas fa-image mr-2"></i> Promijeni fotografiju
          </a>
          <div class="dropdown-divider"></div>
          <a href="{{ route('head_admin.logout') }}" class="dropdown-item dropdown-footer">
          Odjavi se
        </a>
        </div>
      </li>
