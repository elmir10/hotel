...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/dashboard" class="brand-link">
      <img src="{{ url('/upload/AdminLTELogo.png') }}" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ (!empty($data->photo)) ? url('upload/admin_images/'.$data->photo) : url('upload/no_image.jpg') }}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('admin.all_reservations') }}" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('admin.all_messages') }}" class="nav-link">
                  <i class="far fa-arrow-right nav-icon"></i>
                  <p>Sve poruke</p>
                </a>
              </li>
